...
let s:text = "#adbac7"
let s:subtext1 = "#909dab"
let s:subtext0 = "#768390"
let s:overlay2 = "#636e7b"
let s:overlay1 = "#545d68"
let s:overlay0 = "#444c56"
let s:surface2 = "#373e47"
let s:surface1 = "#2d333b"
let s:surface0 = "#272e35"
...
call s:hi("IncSearch", "NONE", s:surface1, s:orange, "NONE", "NONE")
...
call s:hi("Search", "NONE", s:orange, s:surface1, "bold", "bold")
...
call s:hi("TabLineSel", "NONE", s:text, s:surface1, "NONE", "NONE")
...
call s:hi("Constant", "NONE", s:blue, "NONE", "NONE", "NONE")
...
call s:hi("Type", "NONE", s:purple, "NONE", "NONE", "NONE")
call s:hi("Special", "NONE", s:purple, "NONE", "NONE", "NONE")
call s:hi("Underlined", "NONE", s:text, s:base, "underline", "underline")
call s:hi("Error", "NONE", s:red, "NONE", "NONE", "NONE")
call s:hi("Todo", "NONE", s:base, s:pink, "bold", "bold")

call s:hi("String", "NONE", s:cyan, "NONE", "NONE", "NONE")
call s:hi("Character", "NONE", s:cyan, "NONE", "NONE", "NONE")
call s:hi("Number", "NONE", s:blue, "NONE", "NONE", "NONE")
call s:hi("Boolean", "NONE", s:blue, "NONE", "NONE", "NONE")
call s:hi("Float", "NONE", s:blue, "NONE", "NONE", "NONE")
call s:hi("Function", "NONE", s:purple, "NONE", "NONE", "NONE")
call s:hi("Conditional", "NONE", s:red, "NONE", "NONE", "NONE")
call s:hi("Repeat", "NONE", s:red, "NONE", "NONE", "NONE")
call s:hi("Label", "NONE", s:blue, "NONE", "NONE", "NONE")
...
let g:terminal_ansi_colors = [
  \ s:overlay1, s:red, s:green, s:yellow, s:blue, s:purple, s:cyan, s:subtext1,
  \ s:overlay2, s:pink, s:green, s:orange, s:blue, s:purple, s:cyan, s:text
\ ]
